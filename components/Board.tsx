...
import { ToolType, DrawingSettings, Point, BoardHandle } from '../types';
  ...
  useImperativeHandle(ref, () => ({
    ...
    load: (data: ImageData | null) => {
      ...
      if (data) {
        ...
        // Set history to this state so undo works from here (or reset to 1 item)
        setHistory([data]);
      } else {
        // New board
        setHistory([]);
      }
      setPastedImage(null); // Clear pasted images when switching
    }
  }));
